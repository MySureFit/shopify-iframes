  ...
  return (
    <div className={`tec_product_box withoutModel${added ? ' activeproduct' : ''}`} id={`tec_product_box_no_mod_${id}`}>
      <a href="javascript:void(0);" className="fitting_room_cl_prod_link withoutModel">
        ...
        {image
          ? <img src={image} alt={title} className="tec_product_box_img lazy_load_img" loading="lazy" />
      ...
      >
        ...
        <img src="/assets/try-it-on.png" className="fr_product_try_btn" alt="Add to fitting room" />
      </button>
    </div>
  );
}
